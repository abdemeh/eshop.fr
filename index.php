...
<div class="container">
    ...
    <div class="card p-4 mt-2">
        ...
        <section class="features-icons text-center mt-4">
            <div class="container">
                <div class="row">
                    <div class="col-lg-4">
                        <div class="features-icons-item mx-auto mb-5 mb-lg-0 mb-lg-3">
                            <div class="features-icons-icon d-flex"><i class="fa fa-list m-auto text-primary"></i></div>
                            <p class="h3 font-weight-bold">Plusieurs produits</p>
                    ...
                    <div class="col-lg-4">
                        <div class="features-icons-item mx-auto mb-5 mb-lg-0 mb-lg-3">
                            ...
                            <p class="h3 font-weight-bold">Créer votre compte</p>
                    ...
                    <div class="col-lg-4">
                        <div class="features-icons-item mx-auto mb-0 mb-lg-3">
                            ...
                            <p class="h3 font-weight-bold">Appelez-nous</p>
