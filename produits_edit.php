                    ...
                    <tbody>
                        <tr id="tr-ajouter-produit" hidden>
                            ...
                            <form method="post" id="form-ajouter-produit" action="php/ajouter_produit.php">
                                ...
                                <td class="align-middle text-center table-stock"><input name="stock" class="form-control" style="width: 60px;" type="text" value=""></td>
                                <td class="align-middle text-center table-stock"><select name="categorie" class="form-control" style="width: 180px;">
                        ...
                        foreach ($products as $product) : ?>
                            <tr>
                                ...
                                <form method="post" action="php/update_product.php">
                                    ...
                                    <td class="align-middle text-center table-stock"><input name="stock" class="form-control" style="width: 60px;" type="text" value="<?php echo $product['stock']; ?>"></td>
                                    <td class="align-middle text-center table-stock"><select name="categorie" class="form-control" style="width: 180px;">
                                                                                        <?php foreach ($categories as $category) : ?>
                                    ...
                                    <form method="post" action="php/ajouter_categorie.php">
                                        ...
                                        <td class="align-middle text-center">
                                            <form method="post" action="php/update_categorie.php">
                                                ...
                                                <button class="btn btn-primary btn-add-to-cart" type="submit">Ajouter</button>
                                            </form>                                     
